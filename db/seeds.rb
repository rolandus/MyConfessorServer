...
State.create(name: "zzPassword", abbreviation: generated_password)
UserAccount.create(first_name: "System",
                   last_name: "User",
                   #username: "system@myconfessor.org",
                   password: generated_password,
                   account_status_id: 2,
                   account_role_ids: [1, 2],
...
ConfessorRequest.create(first_name: "Larry",
                        last_name: "VanDamme",
                        email: "lvandamme@mtu.edu",
                        diocese_id: 88,
                        state_id: 23,
                        confessor_request_status_id: 1)
ConfessorRequestChange.create(confessor_request_id: 1,
                        first_name: "Larry",
                        last_name: "VanDamme",
                        email: "lvandamme@mtu.edu",
                        diocese_id: 88,
